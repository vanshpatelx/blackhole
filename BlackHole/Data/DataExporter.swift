...
enum DataExporter {
    ...
    static func makeBackup(context: ModelContext) throws -> Data {
        ...
        let backup = BlackHoleBackup(
            tasks: tasks.map { .init(id: $0.id, title: $0.title, dayKey: $0.dayKey, sortIndex: $0.sortIndex, isDone: $0.isDone,
                                     completedAt: $0.completedAt, timeLimitSec: $0.timeLimitSec, reminderAt: $0.reminderAt, createdAt: $0.createdAt) },
            sessions: sessions.map { .init(id: $0.id, taskID: $0.taskID, startedAt: $0.startedAt, endedAt: $0.endedAt,
                                           accumulatedSec: $0.accumulatedSec, targetSec: $0.targetSec) },
